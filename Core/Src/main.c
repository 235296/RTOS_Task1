...
osThreadId TasResetHandle;
/* USER CODE BEGIN PV */
uint32_t freq = 1; // Default frequency of diode blinking in Hz
/* USER CODE END PV */
...
/* USER CODE BEGIN Header_StartTaskReset */
/**
* @brief Function implementing the TasReset thread.
* @param argument: Not used
* @retval None
*/
